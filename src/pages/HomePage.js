...
function HomePage({ habits, challenges }) {
  ...
  const totalCompletions = habits.reduce((sum, h) => sum + (h.records?.length || 0), 0);
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <div style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(10px)', borderRadius: '20px', padding: '25px', textAlign: 'center', color: 'white' }}>
      ...
      <div style={{ background: 'rgba(255,255,255,0.1)', borderRadius: '20px', padding: '30px', textAlign: 'center', color: 'white' }}>
        <h3>💡 Quick Tips</h3>
